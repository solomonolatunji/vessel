...
func (s *Server) registerRoutes() {
	...
	authGroup.POST("/projects/:id/deploy", s.deploymentHandler.DeployProject)
	...
	authGroup.GET("/projects/:id/env", s.projectEnvHandler.GetVars)
	authGroup.PUT("/projects/:id/env", s.projectEnvHandler.SetVars)
	authGroup.GET("/databases", s.dbHandler.ListDatabases)
	authGroup.POST("/databases", s.dbHandler.CreateDatabase)
	authGroup.GET("/databases/:id", s.dbHandler.GetDatabase)
	authGroup.DELETE("/databases/:id", s.dbHandler.DeleteDatabase)
	authGroup.POST("/databases/:id/start", s.dbHandler.StartDatabase)
	authGroup.POST("/databases/:id/stop", s.dbHandler.StopDatabase)
	...
	authGroup.GET("/deployments/:id/logs", s.deploymentHandler.GetLogs)
	...
	authGroup.GET("/projects/:projectId/tokens", s.projectSettingsHandler.ListTokens)
	authGroup.POST("/projects/:projectId/tokens", s.projectSettingsHandler.CreateToken)
	authGroup.DELETE("/projects/:projectId/tokens/:id", s.projectSettingsHandler.DeleteToken)
