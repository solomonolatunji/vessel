...
func (s *Server) registerRoutes() {
	...
	authGroup.GET("/services/:serviceId/webhooks", s.projectSettingsHandler.ListWebhooks)
	authGroup.POST("/services/:serviceId/webhooks", s.projectSettingsHandler.CreateWebhook)
	authGroup.DELETE("/services/:serviceId/webhooks/:id", s.projectSettingsHandler.DeleteWebhook)
