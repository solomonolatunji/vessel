...
func (s *Server) registerRoutes() {
	...
	authGroup.GET("/workspaces/:id/members", s.workspaceHandler.ListMembers)
	authGroup.POST("/workspaces/:id/invite", s.workspaceHandler.InviteMember)
	authGroup.DELETE("/workspaces/:id/members/:userId", s.workspaceHandler.RemoveMember)
	apiGroup.GET("/workspace-invites/:token", s.workspaceHandler.GetInvite)
	authGroup.POST("/workspace-invites/:token/accept", s.workspaceHandler.AcceptInvite)
	authGroup.GET("/workspaces/:workspaceId/trusted-domains", s.workspaceHandler.ListTrustedDomains)
	authGroup.POST("/workspaces/:workspaceId/trusted-domains", s.workspaceHandler.CreateTrustedDomain)
	authGroup.DELETE("/trusted-domains/:id", s.workspaceHandler.DeleteTrustedDomain)
	authGroup.GET("/workspaces/:workspaceId/ssh-keys", s.workspaceHandler.ListSSHKeys)
	authGroup.POST("/workspaces/:workspaceId/ssh-keys", s.workspaceHandler.CreateSSHKey)
	...
	authGroup.GET("/settings/notifications/:id", s.settingsHandler.GetWorkspaceNotificationChannel)
	...
	authGroup.GET("/workspaces/:workspaceId/ai_settings", s.aiSettingsHandler.Get)
	apiGroup.PUT("/workspaces/:workspaceId/ai_settings", s.aiSettingsHandler.Save, s.authGuard.RequireAuth())

	authGroup.GET("/workspaces/:workspaceId/email_settings", s.emailSettingsHandler.GetWorkspaceEmailSettings)
	apiGroup.PUT("/workspaces/:workspaceId/email_settings", s.emailSettingsHandler.SaveWorkspaceEmailSettings, s.authGuard.RequireAuth())
