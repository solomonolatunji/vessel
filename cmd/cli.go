...
func printHelp() {
	...
	fmt.Printf("  deploy --compose <file>  Deploy a docker-compose.yml\n")
	fmt.Printf("  e.g.  deploy --image nginx:latest --port 80\n")
	fmt.Printf("  e.g.  deploy --compose ./docker-compose.yml\n")
